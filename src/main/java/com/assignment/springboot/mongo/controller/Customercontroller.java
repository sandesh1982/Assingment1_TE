...
import com.assignment.springboot.mongo.exception.CustomerNotFoundException;
...
public class Customercontroller {
	...
	public String createCustomer(@RequestBody List<Customer> cust) {
	...
	public String updateCustomer(@PathVariable(value= "customernumber") int id, @RequestBody Customer c) {
		logger.debug("Updating Customer with customernumber= {}.", id);
		Customer cust = serv.findCustomerById(id);
		if(cust==null)
		{
			throw new CustomerNotFoundException("Invalid Customer id  for update: " + id);
		}
		else {
		c.setId(id);
	...
	public String deleteCustomer(@PathVariable(value= "customernumber") int id) {
		logger.debug("Deleting customer with customernumber= {}.", id);
		Customer cust = serv.findCustomerById(id);
		if(cust==null)
		{
			throw new CustomerNotFoundException("Invalid Customer id  for delete: " + id);
		}
		else {
